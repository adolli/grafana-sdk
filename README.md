...
# Grafana SDK [![Go Report Card](https://goreportcard.com/badge/github.com/adolli/grafana-sdk)](https://goreportcard.com/report/github.com/adolli/grafana-sdk)
...
## Examples [![GoDoc](https://godoc.org/github.com/adolli/grafana-sdk?status.svg)](https://godoc.org/github.com/adolli/grafana-sdk)
...
## Installation [![Build Status](https://travis-ci.org/adolli/grafana-sdk.svg?branch=master)](https://travis-ci.org/adolli/grafana-sdk)

Of course Go development environment should be set up first. Then:

	go get github.com/adolli/grafana-sdk
...
## Status of REST API realization [![Coverage Status](https://coveralls.io/repos/github/adolli/grafana-sdk/badge.svg?branch=master)](https://coveralls.io/github/adolli/grafana-sdk?branch=master)
...
https://github.com/adolli/grafana-sdk
